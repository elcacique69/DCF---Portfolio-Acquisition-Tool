...
def fc_dcf_cashflow(closing_date,
                    insurance_fees,
                    agency_fees,
                    handling_fees,
                    bad_debt,
    ...
    df_portfolio['Remaining Contract (days)'] = df_portfolio['End Contract Date'] - df_portfolio['Closing Date']
...
dcf = fc_dcf_cashflow(datetime.strptime('2023-06-30', '%Y-%m-%d'), 0.003, 0.007, 0.002, 0.005, 0.01794847,
